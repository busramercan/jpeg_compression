...
#
# Generated by Vivado on Tue Aug 22 11:20:34 +0300 2023
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/busra/Vivado/ImageCompression/image_compression_communication/image_compression_communication.cache/compile_simlib/activehdl"
  fi
