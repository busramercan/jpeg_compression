...
HD_PWD='C:/Users/busra/Vivado/ImageCompression/image_compression_communication/image_compression_communication.runs/zynq_design_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_design_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_design_blk_mem_gen_0_0.tcl
